...
<div class="container">
   ...
   <br>
    ...
    <div class="col-md-3 col-sm-6 ">
                <div class="p-4"></div>
                <img src="{{ asset('image/tentang/nike.png')}}" class="card-img-top" alt="" width="170" height="170">
   ...
   <br>
        ...
        <div class="p-4"></div>
        <img src="{{ asset('image/tentang/arita.png')}}" class="card-img-top" alt="" width="170" height="170">
                <div class="card" style="width: 12rem; border:none;">
                        <div class="card-body">
   ...
   <br>
    ...
    <div class="col-md-3 col-sm-6 ">
                <div class="p-4"></div>
                <img src="{{ asset('image/tentang/aldo.png')}}" class="card-img-top" alt="" width="170" height="170">
                <div class="card" style="width: 12rem; border:none;">
                        <div class="card-body">
   ...
   <br>
        ...
        <div class="col-md-3 col-sm-12">
        <div class="p-4"></div>
        <img src="{{ asset('image/tentang/rafif.png')}}" class="card-img-top" alt="" width="170" height="170">
                <div class="card" style="width: 12rem; border:none;">
                        <div class="card-body">
