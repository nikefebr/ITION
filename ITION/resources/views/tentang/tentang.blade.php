    ...
    <div class="container">
        <div class="row p-5">
            ...
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12text-ition">
                ...
                <p class="text-black text-deskripsi">
    ...
    <div class="content-nilai">
        <div class="row d-flex justify-content-center" data-aos="fade-up">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="card shadow margin-50" style="background-color:#003567; width: 15rem; height: 16rem; border-radius:30px;">
                    <div class="card-body px-4">
                            <br/> <br/> <br/> <p class="card-text fw-bold text-white">Memotivasi</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"> 
                ...
                <div class="card shadow margin-50 " style="background-color:#003567; width: 15rem; height: 16rem; border-radius:30px;">
                    <div class="card-body px-4">
                        <br/> <br/> <br/> <p class="card-text fw-bold text-white">Akurat</p>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="card shadow margin-50" style="background-color:#003567; width: 15rem; height: 16rem; border-radius:30px;">   
                    <div class="card-body px-4"> <br>    
                          <br/> <br/> <p class="card-text fw-bold text-white">Integrasi</p>
