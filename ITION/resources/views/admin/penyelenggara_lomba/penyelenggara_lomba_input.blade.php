        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action='/admin/penyelenggara'>
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="nama_penyelenggara">Nama Penyelenggara</label>
                      <input type="text" class="form-control" id="nama_penyelenggara" name="nama_penyelenggara" placeholder="Nama Penyelenggara">
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <label for="kontak">Nomor Kontak</label>
                      <input type="text" class="form-control" id="kontak" name="kontak" placeholder="Nomor Kontak">
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
