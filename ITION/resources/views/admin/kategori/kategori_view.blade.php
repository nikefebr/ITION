                        ...
                        <div class="card-body">
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                              ...
                              <td>
                                <form method="post" action="{{ route('kategori destroy', $kategori->id_kategori) }}" >
                                <div class="btn-group">
                                  <a class="btn btn-warning" href="{{ route('kategori edit', $kategori->id_kategori) }}">Edit</button></a>
                                  @csrf
                                  @method('DELETE')
