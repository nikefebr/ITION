            ...
            <div class="row">            
                ...
                <div class="col-md-4 col-sm-6 float-start">
                    <div class="card" style="background-color:#F4F4F4; width: 18rem; border:none;">
                        <img src="{{ url('image/galeri/'.$item->foto) }}" id="<?php echo $index++ ?>" class="card-img-top galeri-item" role="button" alt="" width="200" height="200" data-toggle="modal" data-target="#galeri-popup">
                            <div class="card-body">
